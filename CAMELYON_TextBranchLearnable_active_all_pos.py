...
class Active_FewShotBag_FewShotInstance(torch.utils.data.Dataset):
    def __init__(self, args, ds, num_bag_shot=-1, num_instance_shot=-1):
        ...
        if 'falst' in args.patch_active_method.lower():
            ...
            if args.patch_active_method.lower() == 'falst_v2':
                bag_instance_shot_indexes_from_pos_slides = al.falst_patch_selector_v2(
                    args=args, ds=ds,
            ...
            for bag_shot_idx in self.bag_shot_indexes:
                ...
                # actively select few-shot patches from positive slides
                    ...
                    if args.patch_active_method.lower() == 'oracle':
                        ...
                        instance_few_shot_pos_idx = al.oracle_patch_selector(num_instance_shot, all_pos_instance_idx)
                        instance_few_shot_neg_idx = []
                    else:
