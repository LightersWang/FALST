...
class CAMELYON_16_10x(torch.utils.data.Dataset):
    # @profile
    def __init__(self, root_dir='/home/xiaoyuan/Data/CAMELYON16/patches_byDSMIL_224x224_10x',
...
class CAMELYON_16_5x(torch.utils.data.Dataset):
    # @profile
    def __init__(self, root_dir='/home/xiaoyuan/Data/CAMELYON16/patches_byDSMIL_224x224_5x',
                 train=True, transform=None, downsample=0.2, pos_region_threshold=0.5, return_bag=False):
        self.root_dir = root_dir
        self.train = train
        self.transform = transform
...
class CAMELYON_16_5x_feat(torch.utils.data.Dataset):
    ...
    def __init__(self, root_dir='/home/xiaoyuan/Data/CAMELYON16/patches_byDSMIL_224x224_5x',
        ...
        if (feat == 'CLIP') or (feat == 'CLIP_RN50') or (feat == 'RN50'):
            ...
            save_path = "/media/temp/DATA21/Project_FAST/CODE/MIL_CLIP_Adapter/output_CAMELYON_feat_224x224_5x"
        else:
