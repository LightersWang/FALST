...
#         DATE=$(date +"%Y%m%d_%H%M%S")
#         ROOT_DIR=/media/temp/DATA21/Project_FAST/CODE/FALST/log/CAMELYON_TextBranchLearnable_20250318_all_pos/Slide_${SLIDE_AL}_Patch_${PATCH_AL}_${DATE}
#         echo ${ROOT_DIR}
#         mkdir -p ${ROOT_DIR}/4_InstanceShot
#         mkdir -p ${ROOT_DIR}/16_InstanceShot
#         mkdir -p ${ROOT_DIR}/64_InstanceShot
#         bash /media/temp/DATA21/Project_FAST/CODE/FALST/exp_CAMELYON_TextBranchLearnable_active_fast_all_pos_oracle.sh ${SLIDE_AL} ${PATCH_AL} ${ROOT_DIR}
#     done
# done

# for SLIDE_AL in random; do
#     for PATCH_AL in kmeans; do
#         DATE=$(date +"%Y%m%d_%H%M%S")
#         ROOT_DIR=/media/temp/DATA21/Project_FAST/CODE/FALST/log/CAMELYON_TextBranchLearnable_20250318_all_pos/Slide_${SLIDE_AL}_Patch_${PATCH_AL}_${DATE}
#         echo ${ROOT_DIR}
#         mkdir -p ${ROOT_DIR}/4_InstanceShot
#         mkdir -p ${ROOT_DIR}/16_InstanceShot
#         mkdir -p ${ROOT_DIR}/64_InstanceShot
#         bash /media/temp/DATA21/Project_FAST/CODE/FALST/exp_CAMELYON_TextBranchLearnable_active_fast_all_pos_kmeans.sh ${SLIDE_AL} ${PATCH_AL} ${ROOT_DIR}
#     done
# done

# for SLIDE_AL in random; do
#     for PATCH_AL in coreset; do
#         DATE=$(date +"%Y%m%d_%H%M%S")
#         ROOT_DIR=/media/temp/DATA21/Project_FAST/CODE/FALST/log/CAMELYON_TextBranchLearnable_20250318_all_pos/Slide_${SLIDE_AL}_Patch_${PATCH_AL}_${DATE}
#         echo ${ROOT_DIR}
#         mkdir -p ${ROOT_DIR}/4_InstanceShot
#         mkdir -p ${ROOT_DIR}/16_InstanceShot
#         mkdir -p ${ROOT_DIR}/64_InstanceShot
#         bash /media/temp/DATA21/Project_FAST/CODE/FALST/exp_CAMELYON_TextBranchLearnable_active_fast_all_pos_coreset.sh ${SLIDE_AL} ${PATCH_AL} ${ROOT_DIR}
#     done
# done

# for SLIDE_AL in random; do
#     for PATCH_AL in ra; do
#         DATE=$(date +"%Y%m%d_%H%M%S")
#         ROOT_DIR=/media/temp/DATA21/Project_FAST/CODE/FALST/log/CAMELYON_TextBranchLearnable_20250318_all_pos/Slide_${SLIDE_AL}_Patch_${PATCH_AL}_${DATE}
#         echo ${ROOT_DIR}
#         mkdir -p ${ROOT_DIR}/4_InstanceShot
#         mkdir -p ${ROOT_DIR}/16_InstanceShot
#         mkdir -p ${ROOT_DIR}/64_InstanceShot
#         bash /media/temp/DATA21/Project_FAST/CODE/FALST/exp_CAMELYON_TextBranchLearnable_active_fast_all_pos_ra.sh ${SLIDE_AL} ${PATCH_AL} ${ROOT_DIR}
#     done
# done

# for SLIDE_AL in random; do
#     for PATCH_AL in falst_v2; do
#         DATE=$(date +"%Y%m%d_%H%M%S")
...
#     for PATCH_AL in falst; do
#         DATE=$(date +"%Y%m%d_%H%M%S")
#         ROOT_DIR=/media/temp/DATA21/Project_FAST/CODE/FALST/log/CAMELYON_TextBranchLearnable_20250318_all_pos/Slide_${SLIDE_AL}_Patch_${PATCH_AL}_kde_${DATE}
#         echo ${ROOT_DIR}
#         mkdir -p ${ROOT_DIR}/4_InstanceShot
#         mkdir -p ${ROOT_DIR}/16_InstanceShot
